...
void AALSBaseCharacter::SetOverlayState_Implementation(const EALSOverlayState NewState, bool bForce)
{
...
FRotator AALSBaseCharacter::GetAimingRotation_Implementation()
{
...
void AALSBaseCharacter::UpdateGroundedRotation_Implementation(float DeltaTime)
{
	if (MovementAction == EALSMovementAction::None)
	{
