...
public:
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ALS|Character States")
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "ALS|Essential Information")
...
public:
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category="Player|UI")
