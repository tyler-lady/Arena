...
public:
	...
	const bool& Fencer() const { return Fencer_; }
	const bool& Longsword() const { return Longsword_; }
	const bool& Spear() const { return Spear_; }
	const bool& Halberd() const { return Halberd_; }
	const bool& SandS() const { return SandS_; }
	const bool& Rider() const { return Rider_; }
	...
	void operator=(const EALSOverlayState NewAction)
	{
		...
		Fencer_ = State == EALSOverlayState::Fencer;
		Longsword_ = State == EALSOverlayState::Longsword;
		Spear_ = State == EALSOverlayState::Spear;
		Halberd_ = State == EALSOverlayState::Halberd;
		SandS_ = State == EALSOverlayState::SnS;
		Rider_ = State == EALSOverlayState::Rider;
	}
};
