...
USTRUCT(BlueprintType)
struct FALSAnimGraphHandIK
{
	GENERATED_BODY()

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "ALS|Anim Graph - Hand IK")
	bool isLH;
...
USTRUCT(BlueprintType)
struct FALSQueuedTurnInPlace
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ALS|Turn In Place")
	FALSTurnInPlaceAsset QueuedTurnInPlaceAsset;
