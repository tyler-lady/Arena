...
{
	// Mapping Attribute Tags to actual attributes using delegates
...
//To Properly clamp the value, we clamp here and on PostGameplayEffectExecute
...
{
	//Source - Causes the effect
	//Target - target of effect and owner of THIS Attribute Set
...
void UAuraAttributeSet::PostGameplayEffectExecute(const struct FGameplayEffectModCallbackData& Data)
{
	...
	{
		//Print Health Value to the screen
	...
	{
		//Print Mana Value to the screen
